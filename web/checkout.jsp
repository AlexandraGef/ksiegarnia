...
<%
    ...
    if (deliveryMethod.equals("Paczka pocztowa")) {
        self = "checked";
    } else if (deliveryMethod.equals("Kurier")) {
        courier = "checked";
    } else {
        self = "checked";
    }
...
<html>
    ...
    <body>
        ...
        <div id="form">
            <h2 align="center">Wypełnij podane pola aby dokonać zamówienia:</h2>
            <form action="proceed.jsp">
                ...
                <div align="center">
                    Metoda dostawy:
                    <label>
                        <input type="radio" name="delivery_method" value="Paczka pocztowa" <%=self%>>
                        Paczka pocztowa (darmowa)
                    </label>
                    <label>
                        <input type="radio" name="delivery_method" value="Kurier" <%=courier%>>
                        kurier (15zł)
                    </label>
                    <br><br>
