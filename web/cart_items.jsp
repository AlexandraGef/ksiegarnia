        ...
        <div id="form">
            <%
                ...
                if (cart.getBookCount() == 0) { 
                    out.println("Nie posiadasz żadnych książek w koszyku.");
                    check = false;
                } else {
                    float sum = 0;
                    ...
                    out.println("<h3 align='center'>Wartość produktów: <font color='red'>" + sum + "zł</font></h3>");          
            %>
            <table>
            <%
                    for (int i = 0; i < cart.getBookCount(); i++) {
            ...
            %>
                <tr>
                    ...
                    <%=tags.getColumnSpace(5)%>
                    <td>
                        <b><%=book.getTitle()%></b> napisana przez 
                        <%
                            try {
                    ...
                    <td>
                        Suma częściowa: 
                        <font color="red">
                            <%out.println(cart.getBookAt(i).getPrice() * cart.getBookAt(i).getQuantity());%>zł
                        </font>
                        &nbsp;<br>
                        &nbsp;<br>
                    </td>
